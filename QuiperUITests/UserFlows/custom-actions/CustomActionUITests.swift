...
final class CustomActionUITests: BaseUITest {
    ...
    func testCustomActionLifecycle() throws {
        ...
        // Using `webView.typeKey` ensures the window is the Key Window before typing,
        // avoiding "missing event" issues in headless CI.
        webView.typeKey("k", modifierFlags: [.command, .option, .shift])
        app.typeKey("k", modifierFlags: [.command, .option, .shift])
