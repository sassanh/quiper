...
final class EngineMetadataMigrationManager {
    ...
    func migrateMetadata(for serviceID: UUID, context: LAContext) async throws {
        ...
        Settings.shared.services[index].preservePrompt = true
        Settings.shared.services[index].templateActionScriptSync = [:]
        Settings.shared.services[index].templatePromptInputSelectorSync = false
        Settings.shared.services[index].templateCustomCSSSync = false
