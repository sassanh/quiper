...
extension MainWindowController {
    ...
    func updateCollectionBehaviorForVisibilityState() {
        ...
        // Force AppKit to send an update to WindowServer by toggling if it's supposed to be omnipresent
        ...
        if let bw = blurWindow {
            ...
            if bwBehavior.contains(.canJoinAllSpaces) {
        ...
        if let findBarPanel = findBarViewController?.panel {
            ...
            if fbBehavior.contains(.canJoinAllSpaces) {
