...
- **Window on All Spaces Toggle ([AppearanceSettingsView.swift](Quiper/AppearanceSettingsView.swift), [MainWindowController.swift](Quiper/MainWindowController.swift))**: Added a new setting under Appearance -> Window allowing the user to configure the Quiper main window to stay visible across all macOS desktop spaces.
